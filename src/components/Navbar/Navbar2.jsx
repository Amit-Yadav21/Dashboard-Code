    ...
    <div>
      <div className="navbar2">
        <div className="navbar-logo">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTm_9rsN-HEoamSKWLyft8GqwArqoKUnCZTuA&s"
            alt="Logo"
          />
          <h2 className="nav2-h">Dashboard</h2>
        </div>
        <div className="navbar-content">
          <div className="nav2-ul">
            <ul className="nav2-ul">
              ...
              {/* <li className="nav2-more" onClick={toggleDropdown}>
                More...
              </li> */}
            </ul>
          </div>
